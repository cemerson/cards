...
// INSERT POINT: _init
  ...
  _move: function (e) {
    ...
    if ( !this.moved ) {
      ...
      // cemerson - HARD CODE prevent scrollstart if moving on X not Y...
      if((deltaX > 1) || (deltaX < -1)){ // console.log('deltaY? [' + deltaY + ']');
        //console.log('deltaY: ' + deltaY); //y1:' + this.lastPointY + ' | y2: ' + point.pageY);
